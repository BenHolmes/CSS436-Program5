...
family_items_to_create = [reservationData.get_andersen_family_item(), reservationData.get_johnson_family_item(), reservationData.get_smith_family_item(), reservationData.get_wakefield_family_item()]
